...
let runningPage = 0;
let curPage = pages[runningPage];
let jslinks = document.getElementById("js-links");
let maintext=document.getElementById("main-text");
//let runningIll= curPage.illustration;
...
function displayCredits() {
    ...
    mainBtnc.addEventListener("click", displayMain);
...
function displayMain() {
    ...
    maintext.innerHTML="<p>" + curPage.text + "<p>";
    //illustration.innerHTML= runningIll; //it says its jus ta string. how do I get that data to not be a string?
    ...
    jslinks.childNodes[1].addEventListener("click", function (){clickedButton(jslinks.childNodes[1].index)});
    //jslinks.childNodes[2].addEventListener("click", function (){clickedButton(jslinks.childNodes[2].index)});
    creditsBtnm.addEventListener("click", displayCredits);
};

/*function getPage (buttonClicked) {
   let nextPage=indexOf(buttonClicked)
    runningPage=runningPaeg+1;
    curPage= Pages[runningPage];
...
function displayDisclaimer() {
    ...
    mainBtnd.addEventListener("click", displayMain);
